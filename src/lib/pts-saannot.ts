...
export const PTS_SAANNOT: PtsKohteenSaanto[] = [
  ...
  { kohde: "Puujulkisivun maalaus", kategoria: "Rakenne", kayttoika: 10, huoltovali: 10,
    lahdeVuosi: (t) => ehkaInt(t?.julkisivu_maalattu_vuosi) ?? ehkaInt(t?.julkisivu_asennettu_vuosi) ?? rakennusVuosi(t),
    koskee: (t) => String(t?.julkisivumateriaali ?? "").toLowerCase().includes("puu") || String(t?.julkisivumateriaali ?? "").toLowerCase().includes("hirsi") },
  // Julkisivun uusiminen / peruskorjaus materiaalin mukaan
  { kohde: "Puujulkisivun uusiminen", kategoria: "Rakenne", kayttoika: 50, huoltovali: 0,
    lahdeVuosi: (t) => ehkaInt(t?.julkisivu_asennettu_vuosi) ?? rakennusVuosi(t),
    koskee: (t) => String(t?.julkisivumateriaali ?? "").toLowerCase().includes("puu") },
  { kohde: "Hirsijulkisivun peruskorjaus", kategoria: "Rakenne", kayttoika: 80, huoltovali: 15,
    lahdeVuosi: (t) => ehkaInt(t?.julkisivu_asennettu_vuosi) ?? rakennusVuosi(t),
    koskee: (t) => String(t?.julkisivumateriaali ?? "").toLowerCase().includes("hirsi") },
  { kohde: "Tiilijulkisivun saumaus", kategoria: "Rakenne", kayttoika: 40, huoltovali: 10,
    lahdeVuosi: (t) => ehkaInt(t?.julkisivu_asennettu_vuosi) ?? rakennusVuosi(t),
    koskee: (t) => String(t?.julkisivumateriaali ?? "").toLowerCase().includes("tiili") },
  { kohde: "Rapatun julkisivun huolto", kategoria: "Rakenne", kayttoika: 30, huoltovali: 10,
    lahdeVuosi: (t) => ehkaInt(t?.julkisivu_asennettu_vuosi) ?? rakennusVuosi(t),
    koskee: (t) => String(t?.julkisivumateriaali ?? "").toLowerCase().includes("rappau") },
  { kohde: "Levyverhouksen uusiminen", kategoria: "Rakenne", kayttoika: 40, huoltovali: 10,
    lahdeVuosi: (t) => ehkaInt(t?.julkisivu_asennettu_vuosi) ?? rakennusVuosi(t),
    koskee: (t) => String(t?.julkisivumateriaali ?? "").toLowerCase().includes("levy") || String(t?.julkisivumateriaali ?? "").toLowerCase().includes("kuitusement") },
  { kohde: "Peltijulkisivun maalaus", kategoria: "Rakenne", kayttoika: 20, huoltovali: 5,
    lahdeVuosi: (t) => ehkaInt(t?.julkisivu_maalattu_vuosi) ?? ehkaInt(t?.julkisivu_asennettu_vuosi) ?? rakennusVuosi(t),
    koskee: (t) => String(t?.julkisivumateriaali ?? "").toLowerCase().includes("pelti") },
