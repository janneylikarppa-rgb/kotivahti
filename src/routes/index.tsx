...
function LandingPage() {
  ...
  return (
    <div
      ...
      style={{ background: "#0D1F14", scrollBehavior: "smooth" }}
    >
      {/* NAV */}
      <nav
        className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${
          scrolled ? "bg-[#0D1F14]/90 backdrop-blur border-b border-border/40" : "bg-transparent"
        }`}
      >
        <div className="mx-auto max-w-7xl px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm">
            <a href="#ominaisuudet" className="text-muted-foreground hover:text-cream transition">
              Ominaisuudet
            </a>
            <a href="#ammattilaiset" className="text-muted-foreground hover:text-cream transition">
              Ammattilaiset
            </a>
            <a href="#hinnat" className="text-muted-foreground hover:text-cream transition">
              Hinnat
            </a>
            <Link to="/login">
        ...
        {menuOpen && (
          <div className="md:hidden bg-[#0D1F14] border-t border-border/40 px-6 py-4 flex flex-col gap-4 text-sm">
      ...
      <section className="min-h-screen flex items-center pt-24 pb-16 px-6 relative overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 80% at 25% 50%, color-mix(in oklab, var(--gold) 10%, transparent), transparent 70%)",
          }}
        />
        <div className="relative mx-auto max-w-7xl grid lg:grid-cols-2 gap-12 items-center w-full">
          <div className="space-y-6 animate-in fade-in slide-in-from-top-4 duration-700">
            ...
            <h1 className="font-serif text-5xl sm:text-6xl lg:text-7xl leading-[1.05] text-cream">
              Pidä talo kunnossa.
              <br />
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              ...
              <a
                href="#ominaisuudet"
                className="text-sm text-cream hover:text-primary transition underline-offset-4 hover:underline"
              >
                Katso miten toimii ↓
              </a>
            </div>
          ...
          <div
            className="rounded-xl border border-border/40 p-6 sm:p-8 shadow-2xl animate-in fade-in slide-in-from-top-6 duration-700 delay-200 fill-mode-both"
            style={{ background: "#142A1A" }}
          >
            <p className="eyebrow text-primary mb-1">Talokirja</p>
            <h3 className="font-serif text-2xl text-cream mb-6">Koivutie 12, Kuopio</h3>
            <div className="grid grid-cols-3 gap-4 mb-6 pb-6 border-b border-border/40">
              {[
                ...
                <div key={s.l}>
                  <div className="font-serif text-3xl text-cream">{s.v}</div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex gap-3">
                ...
                <span className="text-cream/90">Öljykattilan vuosihuolto tehty</span>
              </li>
              <li className="flex gap-3">
                <span className="text-primary">✓</span>
                <span className="text-cream/90">Kylpyhuone remontoitu 2022</span>
              </li>
              <li className="flex gap-3">
                <span className="text-primary">!</span>
      ...
      {/* OMINAISUUDET */}
      <section id="ominaisuudet" className="py-24 px-6" style={{ background: "#0A1A10" }}>
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl mb-14">
            <p className="eyebrow text-primary mb-3 flex items-center gap-3">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={f.title}
                className="rounded-xl border border-border/40 p-6 transition hover:border-primary/60"
                style={{ background: "#142A1A" }}
              >
      ...
      <section id="hinnat" className="py-24 px-6 relative overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 50% 60% at 50% 50%, color-mix(in oklab, var(--gold) 12%, transparent), transparent 70%)",
          }}
        />
