    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between p-12 bg-[oklch(0.18_0.025_150)] overflow-hidden">
        <div className="absolute inset-0 pointer-events-none"
             style={{ background: "radial-gradient(ellipse 60% 80% at 30% 50%, color-mix(in oklab, var(--gold) 8%, transparent), transparent 70%)" }} />
        <div className="relative flex items-center gap-2">
          <div className="grid h-9 w-9 place-items-center rounded-md bg-primary text-primary-foreground font-serif text-lg">K</div>
          <span className="font-serif text-xl text-cream">Kotivahti<span className="text-primary">.</span></span>
        </div>
        <div className="relative">
          ...
          <p className="mt-6 max-w-md text-muted-foreground leading-relaxed">
            Tallenna huollot, seuraa sähkö- ja vesikulutusta ja kuittaa
            vuosikellon työt. Yksi paikka koko talon tiedoille.
          </p>
        </div>
      ...
      <div className="flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md">
          ...
          <p className="text-sm text-muted-foreground mb-8">
            Ei vielä tiliä?{" "}
            <Link to="/rekisteroidy" className="text-primary hover:text-[color:var(--gold-2)] underline-offset-4 hover:underline">
              Luo tili
            </Link>
          </p>
